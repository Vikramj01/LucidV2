"""
retrieve_research_node: load the Research Signal the Market Sizing Agent
will build from — either a specific one passed in, or the Project's latest.

Market Sizing Agent hard-depends on Research having run at least once for
the Project.
"""
...
def retrieve_research_node(state: "MarketSizingState") -> dict:
